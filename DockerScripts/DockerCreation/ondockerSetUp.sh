...
python -c "print('Python commandline'); import RFNN.trainnonlin.training as train; train.run();  import RFNN.trainnonlin.test as test; test.run()" 2>&1  | tee /results/log.txt
